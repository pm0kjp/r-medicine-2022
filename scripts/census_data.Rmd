...
# install.packages(c(knitr", "kableExtra", "tidycensus", "dplyr"), dependencies = TRUE)
...
This is great, but it sure would be nice to see this in a map, to understand larger patterns and see these census tracts in the context of where they are in the city!  We'll tackle that later.
